    ...
    public class PedidosViewModel : INotifyPropertyChanged
    {
        ...
        private async Task GenerarTicketPDF()
        {
            try
            {
                ...
                string ruta = Path.Combine(DeviceInfo.Platform == DevicePlatform.Android ? FileSystem.AppDataDirectory : Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), nombreArchivo);
